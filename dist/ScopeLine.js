...
ScopeLine.prototype = {
     ...
     * @param map
     */
    mount: function mount(map, scope) {
        var i,
            ln,
            d = this.duration || 0,
            p = 0,
     ...
     * @returns {number}
     */
    addProcess: function addProcess(from, to, process, cfg) {
        var i = 0,
     ...
     * @private
     */
    _getIndex: function _getIndex(key) {
     ...
     * @param reset
     */
    go: function go(to, scope, reset) {
        this.goTo(to * this.duration, scope, reset);
        this.__cRPos = to;
        return scope || this.scope;
    },
    getPosAt: function getPosAt(to, scope) {
     ...
     * @param reset
     */
    goTo: function goTo(to, scope, reset) {
